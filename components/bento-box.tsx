...
// Pre-defined widths to avoid impure function calls during render
const SKELETON_WIDTHS = ["75%", "60%", "85%", "45%", "90%", "55%"];
...
const items = [
  {
    ...
    description: (
      <span className="text-sm">
        Instantly schedule meetings and create calendar events using simple,
  ...
  },
  {
    ...
    description: (
      <span className="text-sm">
        Tailor reminders to any specific task or calendar event
      </span>
    ),
    header: <SkeletonTwo />,
  ...
  },
  {
    ...
    description: (
      <span className="text-sm">
        Build a searchable archive of your mind. Capture ideas, notes, and
        fleeting thoughts the moment they strike.
      </span>
    ),
    header: <SkeletonFive />,
    className: "md:col-span-3",
  ...
  },
  {
    ...
    description: (
      <span className="text-sm">
        Record meetings or voice notes for high-accuracy transcription.
        Instantly transform spoken content into your desired output, including
        smart summaries or clear action plans.
      </span>
    ),
    header: <SkeletonFour />,
  ...
  },
  {
    ...
    description: (
      <span className="text-sm">
        Command center for getting things done. Organize, assign, and plan your
        steps.
      </span>
    ),
