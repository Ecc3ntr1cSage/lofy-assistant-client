...
const threadPosts = [
  {
    permalink: "https://www.threads.com/@shashasarah_/post/DPt64f_kjbb",
    id: "ig-tp-DPt64f_kjbb",
  },
  {
    permalink: "https://www.threads.com/@yananazri_/post/DPsfpsVj1iS",
  ...
  {
    permalink: "https://www.threads.com/@shee_miow/post/DQHT4ZfgegD",
    id: "ig-tp-DQHT4ZfgegD",
  },
];
  ...
  return (
    <div className="relative w-full max-w-7xl mx-auto px-4 sm:px-12 py-8">
      ...
      >
        ...
        <Script async src="https://www.threads.com/embed.js" />
      </Carousel>
    </div>
  );
}