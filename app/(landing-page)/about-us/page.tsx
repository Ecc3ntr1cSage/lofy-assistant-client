        ...
        <div className="container mx-auto px-4 py-16 max-w-4xl">
            <div className="text-center mb-16">
                ...
                <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
                    We are passionate about creating innovative solutions that make a difference in million of lives.
                </p>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-8 mb-16">
                <Card>
                    ...
                    <CardContent>
                        <p className="text-muted-foreground">
                            To deliver cutting-edge technology solutions that empower businesses and individuals 
                ...
                <Card>
                    ...
                    <CardContent>
                        <p className="text-muted-foreground">
                            To be the leading provider of innovative digital solutions that transform 
            ...
            <div className="mb-16">
                ...
                <div className="grid md:grid-cols-3 gap-6">
                    ...
                    <Card>
                        ...
                        <CardContent>
                            <p className="text-sm text-muted-foreground text-center">
                                Technical expert specializing in scalable architecture and AI solutions.
                            </p>
                        </CardContent>
                    </Card>
                    ...
                    <Card>
                        <CardHeader className="text-center">
                            <Avatar className="w-20 h-20 mx-auto mb-4">
                                <AvatarImage src="/placeholder-avatar.jpg" alt="Mike Johnson" />
            ...
            <Card>
                ...
                <CardContent>
                    ...
                    <p className="text-muted-foreground">
                        ...
                        We believe in building lasting relationships and delivering solutions that exceed expectations.
                    </p>
                </CardContent>
            </Card>
        </div>
